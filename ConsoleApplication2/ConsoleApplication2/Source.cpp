...
void PRINT(map<int, Kordinate>&mm, list<int>&l) {
...
int main() {
	...
	adjacency_list_t adjacency_list(1000);
	// 0 = a
	...
	//adjacency_list[89].push_back(neighbor(801, 1));
	//adjacency_list[129].push_back(neighbor(801, 1));
	//adjacency_list[169].push_back(neighbor(801, 1));
	//adjacency_list[209].push_back(neighbor(801, 1));
	//adjacency_list[249].push_back(neighbor(801, 1));
	//adjacency_list[289].push_back(neighbor(801, 1));

	//adjacency_list[9].push_back(neighbor(801, 1));
	//adjacency_list[49].push_back(neighbor(801, 1));
	//adjacency_list[89].push_back(neighbor(801, 1));
	//adjacency_list[129].push_back(neighbor(801, 1));
	//adjacency_list[169].push_back(neighbor(801, 1));
	//adjacency_list[209].push_back(neighbor(801, 1));
	...
	list<vertex_t> path = DijkstraGetShortestPathTo(230, previous);
	//cout << "Path : ";
	//int ko = 0;
	//	map<int, Kordinate> mp;
	PRINT(mp, path);
